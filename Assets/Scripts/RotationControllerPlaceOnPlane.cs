...
/// <summary>
/// Controls the orientation of content placed by the <see cref="PlaceOnPlaneRotationReady"/>
/// component using a UI.Slider to affect the rotation about the Y axis.
/// </summary>
[RequireComponent(typeof(PlaceOnPlaneRotationReady))]
public class RotationControllerPlaceOnPlane : MonoBehaviour
{
	PlaceOnPlaneRotationReady m_PlaceOnPlaneRotationReady;
	...
	float angle
	{
		get
		{
			return m_PlaceOnPlaneRotationReady.rotation.eulerAngles.y;
		}
		set
		{
            m_PlaceOnPlaneRotationReady.rotation = Quaternion.AngleAxis(value, Vector3.up);
			UpdateText();
		}
	}
	...
	void Awake()
	{
        m_PlaceOnPlaneRotationReady = GetComponent<PlaceOnPlaneRotationReady>();
	}
